...
func fake(w http.ResponseWriter, r *http.Request) {
	...
	normalRes := `{"code":200,"data":[{"code":200,"msg":"OK","results":[{"label":"porn","rate":99.91,"scene":"antispam","suggestion":"block","details":[{"startTime":0,"endTime":30,"text":"啊。","label":"porn"}]}],"taskId":"vc_f_5M$CW$2MQNI5nL1aAkWzfR-1sR4@n"}],"msg":"OK","requestId":"3612842B-0F3A-4AD4-A6B5-7F7AD4BE1956"}`
